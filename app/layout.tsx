      ...
      <body>
        ...
        <div className="relative z-10 text-on-surface font-body selection:bg-primary selection:text-on-primary overflow-x-hidden">
          ...
          <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-6 h-12 bg-[#0e0e0e] border-b border-[#3b494c]/20">
            <Link href="/">
              <div className="font-mono font-bold text-[#00E5FF] tracking-widest text-sm uppercase">
                Pawwwl_
              </div>
            </Link>
            <div className="flex items-center gap-3">
              <Link href="/showcase">
                <button className="bg-primary text-on-primary px-3 py-1 font-mono text-xs font-bold uppercase hover:bg-[#c3f5ff] transition-all duration-150 active:scale-95">
                  SHOW_CASE
                </button>
              </Link>
            </div>
