...
const CITIES = [
  // ── North America ──────────────────────────────────────────────────────────
  { name: "Mexico City",     country: "MX", continent: "na", lat:  19.43, lon:  -99.13 },
  { name: "New York",        country: "US", continent: "na", lat:  40.71, lon:  -74.01 },
  { name: "Los Angeles",     country: "US", continent: "na", lat:  34.05, lon: -118.24 },
  ...
  { name: "Guadalajara",     country: "MX", continent: "na", lat:  20.67, lon: -103.35 },
  { name: "Havana",          country: "CU", continent: "na", lat:  23.14, lon:  -82.36 },
  { name: "Monterrey",       country: "MX", continent: "na", lat:  25.67, lon: -100.31 },
  { name: "Philadelphia",    country: "US", continent: "na", lat:  39.95, lon:  -75.17 },
  ...
  { name: "San Antonio",     country: "US", continent: "na", lat:  29.42, lon:  -98.49 },
  { name: "Dallas",          country: "US", continent: "na", lat:  32.79, lon:  -96.77 },
  { name: "San Diego",       country: "US", continent: "na", lat:  32.72, lon: -117.16 },
  { name: "Austin",          country: "US", continent: "na", lat:  30.27, lon:  -97.74 },
  { name: "San Jose",        country: "US", continent: "na", lat:  37.34, lon: -121.89 },
  { name: "Jacksonville",    country: "US", continent: "na", lat:  30.33, lon:  -81.66 },
  { name: "Seattle",         country: "US", continent: "na", lat:  47.61, lon: -122.33 },
  { name: "San Francisco",   country: "US", continent: "na", lat:  37.77, lon: -122.42 },
  { name: "Columbus",        country: "US", continent: "na", lat:  39.96, lon:  -82.99 },
  { name: "Denver",          country: "US", continent: "na", lat:  39.74, lon: -104.98 },
  { name: "Washington DC",   country: "US", continent: "na", lat:  38.91, lon:  -77.04 },
  { name: "Nashville",       country: "US", continent: "na", lat:  36.17, lon:  -86.78 },
  { name: "Boston",          country: "US", continent: "na", lat:  42.36, lon:  -71.06 },
  { name: "Las Vegas",       country: "US", continent: "na", lat:  36.17, lon: -115.14 },
  { name: "Portland",        country: "US", continent: "na", lat:  45.52, lon: -122.67 },
  { name: "Charlotte",       country: "US", continent: "na", lat:  35.23, lon:  -80.84 },
  { name: "Indianapolis",    country: "US", continent: "na", lat:  39.77, lon:  -86.16 },
  { name: "Baltimore",       country: "US", continent: "na", lat:  39.29, lon:  -76.61 },
  { name: "Memphis",         country: "US", continent: "na", lat:  35.15, lon:  -90.05 },
  { name: "Louisville",      country: "US", continent: "na", lat:  38.25, lon:  -85.76 },
  { name: "Milwaukee",       country: "US", continent: "na", lat:  43.04, lon:  -87.91 },
  { name: "Vancouver",       country: "CA", continent: "na", lat:  49.25, lon: -123.12 },
  { name: "Ottawa",          country: "CA", continent: "na", lat:  45.42, lon:  -75.70 },
  { name: "Calgary",         country: "CA", continent: "na", lat:  51.05, lon: -114.07 },
  { name: "Edmonton",        country: "CA", continent: "na", lat:  53.55, lon: -113.47 },
  { name: "Winnipeg",        country: "CA", continent: "na", lat:  49.90, lon:  -97.14 },
  { name: "Guatemala City",  country: "GT", continent: "na", lat:  14.64, lon:  -90.51 },
  { name: "Santo Domingo",   country: "DO", continent: "na", lat:  18.48, lon:  -69.90 },
  { name: "San Salvador",    country: "SV", continent: "na", lat:  13.70, lon:  -89.20 },
  { name: "Tegucigalpa",     country: "HN", continent: "na", lat:  14.10, lon:  -87.22 },
  { name: "Port-au-Prince",  country: "HT", continent: "na", lat:  18.54, lon:  -72.34 },
  { name: "Panama City",     country: "PA", continent: "na", lat:   8.99, lon:  -79.52 },
  ...
  { name: "Fort Worth",      country: "US", continent: "na", lat:  32.72, lon:  -97.32 },

  // ── South America ──────────────────────────────────────────────────────────
  { name: "São Paulo",       country: "BR", continent: "sa", lat: -23.55, lon:  -46.63 },
  { name: "Buenos Aires",    country: "AR", continent: "sa", lat: -34.60, lon:  -58.38 },
  { name: "Rio de Janeiro",  country: "BR", continent: "sa", lat: -22.91, lon:  -43.17 },
  { name: "Lima",            country: "PE", continent: "sa", lat: -12.05, lon:  -77.04 },
  { name: "Bogota",          country: "CO", continent: "sa", lat:   4.71, lon:  -74.07 },
  { name: "Santiago",        country: "CL", continent: "sa", lat: -33.46, lon:  -70.65 },
  { name: "Caracas",         country: "VE", continent: "sa", lat:  10.48, lon:  -66.90 },
  { name: "Belo Horizonte",  country: "BR", continent: "sa", lat: -19.92, lon:  -43.94 },
  { name: "Brasilia",        country: "BR", continent: "sa", lat: -15.78, lon:  -47.93 },
  { name: "Medellín",        country: "CO", continent: "sa", lat:   6.25, lon:  -75.56 },
  { name: "Fortaleza",       country: "BR", continent: "sa", lat:  -3.72, lon:  -38.54 },
  { name: "Guayaquil",       country: "EC", continent: "sa", lat:  -2.19, lon:  -79.89 },
  { name: "Cali",            country: "CO", continent: "sa", lat:   3.43, lon:  -76.52 },
  { name: "Manaus",          country: "BR", continent: "sa", lat:  -3.10, lon:  -60.03 },
  { name: "Recife",          country: "BR", continent: "sa", lat:  -8.05, lon:  -34.88 },
  { name: "Curitiba",        country: "BR", continent: "sa", lat: -25.43, lon:  -49.27 },
  { name: "Maracaibo",       country: "VE", continent: "sa", lat:  10.66, lon:  -71.61 },
  { name: "Porto Alegre",    country: "BR", continent: "sa", lat: -30.03, lon:  -51.23 },
  { name: "Quito",           country: "EC", continent: "sa", lat:  -0.22, lon:  -78.51 },
  { name: "Montevideo",      country: "UY", continent: "sa", lat: -34.90, lon:  -56.19 },
  { name: "Belém",           country: "BR", continent: "sa", lat:  -1.45, lon:  -48.50 },
  { name: "Salvador",        country: "BR", continent: "sa", lat: -12.97, lon:  -38.51 },
  { name: "La Paz",          country: "BO", continent: "sa", lat: -16.50, lon:  -68.15 },
  { name: "Rosario",         country: "AR", continent: "sa", lat: -32.95, lon:  -60.64 },
  { name: "Asuncion",        country: "PY", continent: "sa", lat: -25.29, lon:  -57.65 },
  { name: "Córdoba",         country: "AR", continent: "sa", lat: -31.42, lon:  -64.19 },
  { name: "Santa Cruz",      country: "BO", continent: "sa", lat: -17.80, lon:  -63.17 },
  { name: "Goiânia",         country: "BR", continent: "sa", lat: -16.69, lon:  -49.25 },
  { name: "Campinas",        country: "BR", continent: "sa", lat: -22.91, lon:  -47.06 },
  { name: "Guarulhos",       country: "BR", continent: "sa", lat: -23.46, lon:  -46.53 },
  { name: "Barranquilla",    country: "CO", continent: "sa", lat:  10.96, lon:  -74.80 },
  { name: "Florianópolis",   country: "BR", continent: "sa", lat: -27.60, lon:  -48.55 },
  { name: "Natal",           country: "BR", continent: "sa", lat:  -5.80, lon:  -35.21 },
  { name: "Cúcuta",          country: "CO", continent: "sa", lat:   7.89, lon:  -72.50 },
  { name: "Maceió",          country: "BR", continent: "sa", lat:  -9.67, lon:  -35.74 },
  { name: "Teresina",        country: "BR", continent: "sa", lat:  -5.09, lon:  -42.80 },
  { name: "Campo Grande",    country: "BR", continent: "sa", lat: -20.46, lon:  -54.62 },
  { name: "João Pessoa",     country: "BR", continent: "sa", lat:  -7.12, lon:  -34.88 },
  { name: "Aracaju",         country: "BR", continent: "sa", lat: -10.91, lon:  -37.05 },
  { name: "Uberlândia",      country: "BR", continent: "sa", lat: -18.92, lon:  -48.28 },
  { name: "Sorocaba",        country: "BR", continent: "sa", lat: -23.50, lon:  -47.46 },
  { name: "Contagem",        country: "BR", continent: "sa", lat: -19.93, lon:  -44.05 },
  { name: "Ribeirão Preto",  country: "BR", continent: "sa", lat: -21.17, lon:  -47.81 },
  { name: "Porto Velho",     country: "BR", continent: "sa", lat:  -8.76, lon:  -63.90 },
  { name: "Pelotas",         country: "BR", continent: "sa", lat: -31.77, lon:  -52.34 },
  { name: "Duque de Caxias", country: "BR", continent: "sa", lat: -22.79, lon:  -43.31 },
  { name: "Nova Iguaçu",     country: "BR", continent: "sa", lat: -22.76, lon:  -43.45 },
  ...
  { name: "Mar del Plata",   country: "AR", continent: "sa", lat: -38.00, lon:  -57.56 },
  ...
  { name: "Kano",            country: "NG", continent: "af", lat:  12.00, lon:    8.52 },
  { name: "Dar es Salaam",   country: "TZ", continent: "af", lat:  -6.80, lon:   39.27 },
  { name: "Abidjan",         country: "CI", continent: "af", lat:   5.36, lon:   -4.01 },
  { name: "Khartoum",        country: "SD", continent: "af", lat:  15.55, lon:   32.53 },
  { name: "Alexandria",      country: "EG", continent: "af", lat:  31.20, lon:   29.92 },
  { name: "Johannesburg",    country: "ZA", continent: "af", lat: -26.20, lon:   28.04 },
  { name: "Addis Ababa",     country: "ET", continent: "af", lat:   9.03, lon:   38.74 },
  { name: "Ibadan",          country: "NG", continent: "af", lat:   7.38, lon:    3.90 },
  { name: "Nairobi",         country: "KE", continent: "af", lat:  -1.29, lon:   36.82 },
  { name: "Antananarivo",    country: "MG", continent: "af", lat: -18.91, lon:   47.54 },
  { name: "Casablanca",      country: "MA", continent: "af", lat:  33.59, lon:   -7.62 },
  { name: "Douala",          country: "CM", continent: "af", lat:   4.05, lon:    9.70 },
  { name: "Algiers",         country: "DZ", continent: "af", lat:  36.74, lon:    3.06 },
  { name: "Mogadishu",       country: "SO", continent: "af", lat:   2.05, lon:   45.34 },
  { name: "Abuja",           country: "NG", continent: "af", lat:   9.07, lon:    7.40 },
  { name: "Accra",           country: "GH", continent: "af", lat:   5.56, lon:   -0.20 },
  ...
  { name: "Cape Town",       country: "ZA", continent: "af", lat: -33.93, lon:   18.42 },
  ...
  { name: "Bamako",          country: "ML", continent: "af", lat:  12.65, lon:   -8.00 },
  { name: "Harare",          country: "ZW", continent: "af", lat: -17.83, lon:   31.05 },
  { name: "Ouagadougou",     country: "BF", continent: "af", lat:  12.37, lon:   -1.53 },
  { name: "Tripoli",         country: "LY", continent: "af", lat:  32.90, lon:   13.18 },
  ...
  { name: "Brazzaville",     country: "CG", continent: "af", lat:  -4.27, lon:   15.28 },
  ...
  { name: "Port Louis",      country: "MU", continent: "af", lat: -20.16, lon:   57.49 },
  { name: "Malabo",          country: "GQ", continent: "af", lat:   3.75, lon:    8.78 },
  { name: "Moroni",          country: "KM", continent: "af", lat: -11.70, lon:   43.26 },
  ...
  { name: "Madrid",          country: "ES", continent: "eu", lat:  40.42, lon:   -3.70 },
  { name: "Kyiv",            country: "UA", continent: "eu", lat:  50.45, lon:   30.52 },
  { name: "Rome",            country: "IT", continent: "eu", lat:  41.90, lon:   12.48 },
  { name: "Bucharest",       country: "RO", continent: "eu", lat:  44.43, lon:   26.10 },
  { name: "Amsterdam",       country: "NL", continent: "eu", lat:  52.37, lon:    4.90 },
  { name: "Warsaw",          country: "PL", continent: "eu", lat:  52.23, lon:   21.01 },
  { name: "Vienna",          country: "AT", continent: "eu", lat:  48.21, lon:   16.37 },
  { name: "Hamburg",         country: "DE", continent: "eu", lat:  53.55, lon:   10.00 },
  { name: "Budapest",        country: "HU", continent: "eu", lat:  47.50, lon:   19.04 },
  ...
  { name: "Belgrade",        country: "RS", continent: "eu", lat:  44.80, lon:   20.47 },
  { name: "Stockholm",       country: "SE", continent: "eu", lat:  59.33, lon:   18.07 },
  { name: "Prague",          country: "CZ", continent: "eu", lat:  50.08, lon:   14.44 },
  { name: "Copenhagen",      country: "DK", continent: "eu", lat:  55.68, lon:   12.57 },
  ...
  { name: "Minsk",           country: "BY", continent: "eu", lat:  53.90, lon:   27.57 },
  ...
  { name: "Sofia",           country: "BG", continent: "eu", lat:  42.70, lon:   23.32 },
  ...
  { name: "Bratislava",      country: "SK", continent: "eu", lat:  48.15, lon:   17.11 },
  ...
  { name: "Skopje",          country: "MK", continent: "eu", lat:  42.00, lon:   21.43 },
  { name: "Chisinau",        country: "MD", continent: "eu", lat:  47.00, lon:   28.86 },
  { name: "Podgorica",       country: "ME", continent: "eu", lat:  42.44, lon:   19.26 },
  { name: "Reykjavik",       country: "IS", continent: "eu", lat:  64.14, lon:  -21.94 },
  { name: "Nicosia",         country: "CY", continent: "eu", lat:  35.17, lon:   33.37 },
  { name: "Valletta",        country: "MT", continent: "eu", lat:  35.90, lon:   14.51 },
  ...
  { name: "Chongqing",       country: "CN", continent: "as", lat:  29.56, lon:  106.55 },
  { name: "Osaka",           country: "JP", continent: "as", lat:  34.69, lon:  135.50 },
  ...
  { name: "Guangzhou",       country: "CN", continent: "as", lat:  23.13, lon:  113.26 },
  ...
  { name: "Hong Kong",       country: "HK", continent: "as", lat:  22.32, lon:  114.17 },
  ...
  { name: "Ho Chi Minh City",country: "VN", continent: "as", lat:  10.82, lon:  106.63 },
  { name: "Ahmedabad",       country: "IN", continent: "as", lat:  23.03, lon:   72.58 },
  { name: "Hanoi",           country: "VN", continent: "as", lat:  21.03, lon:  105.83 },
  { name: "Kuala Lumpur",    country: "MY", continent: "as", lat:   3.14, lon:  101.69 },
  { name: "Manila",          country: "PH", continent: "as", lat:  14.60, lon:  120.98 },
  { name: "Dubai",           country: "AE", continent: "as", lat:  25.20, lon:   55.27 },
  ...
  { name: "Baghdad",         country: "IQ", continent: "as", lat:  33.33, lon:   44.40 },
  ...
  { name: "Tashkent",        country: "UZ", continent: "as", lat:  41.30, lon:   69.27 },
  { name: "Ulaanbaatar",     country: "MN", continent: "as", lat:  47.91, lon:  106.88 },
  { name: "Phnom Penh",      country: "KH", continent: "as", lat:  11.55, lon:  104.92 },
  { name: "Vientiane",       country: "LA", continent: "as", lat:  17.97, lon:  102.60 },
  ...
  { name: "Pyongyang",       country: "KP", continent: "as", lat:  39.03, lon:  125.75 },
  { name: "Beirut",          country: "LB", continent: "as", lat:  33.89, lon:   35.50 },

  // ── Oceania ────────────────────────────────────────────────────────────────
  { name: "Sydney",          country: "AU", continent: "oc", lat: -33.87, lon:  151.21 },
  { name: "Melbourne",       country: "AU", continent: "oc", lat: -37.81, lon:  144.96 },
  { name: "Brisbane",        country: "AU", continent: "oc", lat: -27.47, lon:  153.03 },
  { name: "Perth",           country: "AU", continent: "oc", lat: -31.95, lon:  115.86 },
  { name: "Auckland",        country: "NZ", continent: "oc", lat: -36.87, lon:  174.77 },
  { name: "Adelaide",        country: "AU", continent: "oc", lat: -34.93, lon:  138.60 },
  { name: "Gold Coast",      country: "AU", continent: "oc", lat: -28.00, lon:  153.43 },
  { name: "Wellington",      country: "NZ", continent: "oc", lat: -41.29, lon:  174.78 },
  { name: "Canberra",        country: "AU", continent: "oc", lat: -35.28, lon:  149.13 },
  { name: "Newcastle",       country: "AU", continent: "oc", lat: -32.93, lon:  151.78 },
  { name: "Port Moresby",    country: "PG", continent: "oc", lat:  -9.44, lon:  147.18 },
  { name: "Christchurch",    country: "NZ", continent: "oc", lat: -43.53, lon:  172.64 },
  { name: "Wollongong",      country: "AU", continent: "oc", lat: -34.43, lon:  150.89 },
  { name: "Geelong",         country: "AU", continent: "oc", lat: -38.15, lon:  144.36 },
  { name: "Hobart",          country: "AU", continent: "oc", lat: -42.88, lon:  147.33 },
  { name: "Townsville",      country: "AU", continent: "oc", lat: -19.26, lon:  146.82 },
  { name: "Darwin",          country: "AU", continent: "oc", lat: -12.46, lon:  130.84 },
  { name: "Cairns",          country: "AU", continent: "oc", lat: -16.92, lon:  145.78 },
  { name: "Hamilton",        country: "NZ", continent: "oc", lat: -37.79, lon:  175.28 },
  { name: "Tauranga",        country: "NZ", continent: "oc", lat: -37.69, lon:  176.17 },
  { name: "Sunshine Coast",  country: "AU", continent: "oc", lat: -26.65, lon:  153.07 },
  { name: "Dunedin",         country: "NZ", continent: "oc", lat: -45.88, lon:  170.50 },
  { name: "Palmerston North",country: "NZ", continent: "oc", lat: -40.36, lon:  175.61 },
  { name: "Suva",            country: "FJ", continent: "oc", lat: -18.14, lon:  178.44 },
  { name: "Toowoomba",       country: "AU", continent: "oc", lat: -27.56, lon:  151.95 },
  { name: "Launceston",      country: "AU", continent: "oc", lat: -41.44, lon:  147.14 },
  { name: "Ballarat",        country: "AU", continent: "oc", lat: -37.56, lon:  143.86 },
  ...
  { name: "Honolulu",        country: "US", continent: "oc", lat:  21.31, lon: -157.86 },
  { name: "Papeete",         country: "PF", continent: "oc", lat: -17.54, lon: -149.57 },
  { name: "Honiara",         country: "SB", continent: "oc", lat:  -9.44, lon:  160.03 },
  { name: "Port Vila",       country: "VU", continent: "oc", lat: -17.73, lon:  168.32 },
  { name: "Noumea",          country: "NC", continent: "oc", lat: -22.27, lon:  166.46 },
  { name: "Nadi",            country: "FJ", continent: "oc", lat: -17.80, lon:  177.41 },
  { name: "Apia",            country: "WS", continent: "oc", lat: -13.83, lon: -171.77 },
  { name: "Nuku'alofa",      country: "TO", continent: "oc", lat: -21.14, lon: -175.22 },
  { name: "Lae",             country: "PG", continent: "oc", lat:  -6.73, lon:  147.00 },
  { name: "Nelson",          country: "NZ", continent: "oc", lat: -41.27, lon:  173.28 },
  { name: "Mackay",          country: "AU", continent: "oc", lat: -21.15, lon:  149.19 },
  { name: "Rockhampton",     country: "AU", continent: "oc", lat: -23.38, lon:  150.51 },
  ...
  { name: "Funafuti",        country: "TV", continent: "oc", lat:  -8.52, lon:  179.20 },
    ...
    chunks.map(async (chunk) => {
      ...
      try {
        ...
        return chunk.map((city, i): WeatherData => {
          const r = results[i];
          if (!r?.current) return { city, temp: 0, windKph: 0, description: "" };
          return {
            city,
        ...
        return chunk.map((city): WeatherData => ({ city, temp: 0, windKph: 0, description: "" }));
      }
    }),
  );
