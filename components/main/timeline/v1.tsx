...
export function TimelineSection() {
  ...
  const [nodeProgress, setNodeProgress] = useState<number[]>(
    Array(N + 1).fill(0),
  );
          ...
          >
            ...
            <g className="blur-[2px] sm:blur-none">
              ...
              {nodeYs.slice(0, -1).map((ny, i) => {
                ...
                const drawnIn = Math.max(
                  0,
                  Math.min(segLen, drawn - (segY1 - y0)),
                );
                return (
                  <line
                    key={i}
          ...
          {TIME_LINE.map((item, i) => {
            ...
            return (
              <div key={i} className="relative z-10 py-16 sm:py-10">
                ...
                >
                  ...
                  <div className="sm:hidden flex items-center justify-between">
                    <div style={{ color, opacity: np }}>
                      ...
                      <p className="text-4xl font-headline font-light tracking-widest leading-none">
                        {year}
                      </p>
                    </div>
                    <div>{headerEl}</div>
                ...
                <div className="sm:hidden mt-6">{descEl}</div>
              </div>
            );
          })}
